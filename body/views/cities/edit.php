    ...
    <form id="add" method="post" class="form-horizontal" action="<?php echo base_url() . 'city/edit/' . $city->id; ?>">
        ...
        foreach ($this->config->item('custom_languages') as $key => $value) {
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input type="text" name="<?php echo $temp; ?>"  class="<?php echo ($key == 'en') ? 'form-control required' : 'form-control'; ?>" placeholder="Country Name in <?php echo ucwords($value); ?>" value="<?php echo $city->$temp; ?>"/>
                </div>
            </div>
        <?php } ?>
