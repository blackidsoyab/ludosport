...
<h1 class="page-heading"><?php echo $school->{$session->language.'_school_name'}; ?></h1>
		...
		<div class="panel with-nav-tabs panel-primary panel-square panel-no-border">
				...
				<ul class="nav nav-tabs">
					...
					<li>
						<a href="#clan-detail" data-toggle="tab">
							...
							<span class="badge badge-primary"><?php echo count($clans->all); ?></span>
						</a>
					</li>
			...
			<div class="panel-body">
				<div class="tab-content">
					...
					<div class="tab-pane fade  in active" id="school-detail">
