...
<h1 class="page-heading"><?php echo $this->lang->line('add'), ' ', $this->lang->line('school'); ?></h1>
<div class="the-box">
    <form id="manage" method="post" class="form-horizontal" action="<?php echo base_url() . 'school/add'; ?>">
        ...
        <fieldset>
            ...
            <?php foreach ($this->config->item('custom_languages') as $key => $value) { ?>
                <div class="form-group">
                    ...
                    <div class="col-lg-5">
                        <input type="text" name="<?php echo $key . '_school_name'; ?>"  class="<?php echo ($key == 'en') ? 'form-control required' : 'form-control'; ?>" placeholder="<?php echo $this->lang->line('school'), ' ', $this->lang->line('name'), ' ', ucwords($value); ?>"/>
                    </div>
                </div>
            <?php } ?>
                ...
                <div class="col-lg-5">
                    <select class="form-control required" name="academy_id">
                        ...
                        foreach ($academies as $academy) {
                            ?>
                            <option value="<?php echo $academy->id; ?>"><?php echo $academy->$temp; ?></option>
                        <?php } ?>     
                    </select>
                </div>
            </div>
