...
if(!is_null($clan_details)){
    $url = base_url() . 'evolutionclan/listEvolutionClanRequestJson' . $clan_details->id;
    $clan_name = ' : '. $clan_details->{$session->language .'_class_name'} ;
}else{
    $url = base_url() . 'evolutionclan/listEvolutionClanRequestJson';
    $clan_name = null;
}
?>
        ...
        <table class="table table-striped table-hover" id="list_data">
            <thead class="the-box dark full">
                <tr align="left">
                    ...
                    <th width="250"><?php echo $this->lang->line('clan'); ?></th>
                    <th width="125"><?php echo ucfirst($this->lang->line('date')); ?></th>
