...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <h1 class="page-heading h1 pull-left"><?php echo $this->lang->line('manage'), ' ', $this->lang->line('evolutionclan'); ?></h1>    

        <?php if (hasPermission('evolutionclans', 'addEvolutionclan')) { ?>
            <a href="<?php echo base_url() . 'evolutionclan/add' ?>" class="btn btn-primary h1 pull-right" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('add'), ' ', $this->lang->line('evolutionclan'); ?>"><?php echo $this->lang->line('add'), ' ', $this->lang->line('evolutionclan'); ?></a>
        <?php } ?>
    </div>
</div>
            ...
            <div class=" col-lg-4">
                <select class="form-control required" id="school_id">
                    ...
                    <?php foreach ($schools as $school) { ?>
                        <option value="<?php echo $school->id; ?>"><?php echo $school->{$session->language . '_school_name'}; ?></option>
                    <?php } ?>    
                </select>
            </div>
        </div>
