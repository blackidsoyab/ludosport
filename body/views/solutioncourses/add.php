...
<div class="the-box">
    ...
    <form id="add" method="post" class="form-horizontal" action="<?php echo base_url() . 'solutioncourse/add'; ?>" enctype="multipart/form-data">
            ...
            <div class="col-lg-5">
                <select class="form-control required" name="type_1">
                    ...
                    <?php foreach ($solution_type_1 as $type_1) { ?>
                        <option value="<?php echo $type_1['id']; ?>"><?php echo $type_1[$session->language . '_name']; ?></option>
                    <?php } ?>     
                </select>
            </div>
        </div>
            ...
            <div class="col-lg-5">
                <select class="form-control required" name="type_2">
                    ...
                    <?php foreach ($solution_type_2 as $type_2) { ?>
                        <option value="<?php echo $type_2['id']; ?>"><?php echo $type_2[$session->language . '_name']; ?></option>
                    <?php } ?>     
                </select>
            </div>
        </div>
        ...
        <?php foreach ($this->config->item('custom_languages') as $key => $value) { ?>
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    <input type="text" name="<?php echo $key . '_name'; ?>"  class="<?php echo ($key == 'en') ? 'form-control required' : 'form-control'; ?>" placeholder="<?php echo $this->lang->line('solution_course'), ' ', $this->lang->line('name'), ' ', ucwords($value); ?>"/>
                </div>
            </div>
        <?php } ?>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <input type="text" name="price"  class="form-control required" placeholder="<?php echo $this->lang->line('price'); ?>"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <textarea  class="form-control bold-border" rows="5" name="description"></textarea>
            </div>
        </div>
