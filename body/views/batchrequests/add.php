...
<div class="the-box">
    ...
    <form id="add" method="post" class="form-horizontal" action="<?php echo base_url() . 'batchrequest/add'; ?>">
            ...
            <div class="col-lg-6">
                <select class="form-control required" name="student_id" id="student_selection">
                    ...
                    <?php foreach ($student_details as $pupil) { ?>
                        <option value="<?php echo $pupil->id; ?>" data-student-avtar="<?php echo $pupil->avtar; ?>"><?php echo $pupil->firstname, ' ', $pupil->lastname; ?></option>
                    <?php } ?>
                </select>
            </div>
            ...
            <div class="col-lg-6">
                <select class="form-control required" name="batch_id" id="batch_selection">
                    ...
                    <?php foreach ($batches as $batch) { ?>
                        <option value="<?php echo $batch->id; ?>" data-batch-image="<?php echo $batch->image; ?>"><?php echo $batch->{$session->language.'_name'}; ?></option>
                    <?php } ?>
                </select>
            </div>
            <div class="batch_img">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-6">
                <textarea rows="5" class="form-control bold-border" name="description"></textarea>
            </div>
        </div>
