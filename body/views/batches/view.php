...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <h1 class="page-heading h1 pull-left"><?php echo $this->lang->line('manage'), ' ', $this->lang->line('batch'); ?></h1>    

        <?php if (hasPermission('batches', 'addBatch')) { ?>
            <a href="<?php echo base_url() . 'batch/add' ?>" class="pull-right btn btn-primary h1 pull-right" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('add'), ' ', $this->lang->line('batch'); ?>"><?php echo $this->lang->line('add'), ' ', $this->lang->line('batch'); ?></a>
        <?php } ?>
    </div>
</div>
