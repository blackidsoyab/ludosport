...
class messages extends CI_Controller
{
    ...
    */
    function uploadAttachments($id) {
        ...
        //Configure upload.
        $this->upload->initialize(array('upload_path' => "./assets/message_attachments/", 'allowed_types' => 'jpg|jpeg|gif|png|bmp', 'overwrite' => FALSE, 'remove_spaces' => TRUE, 'encrypt_name' => TRUE));
