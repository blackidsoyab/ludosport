...
$route['reload_captcha'] = 'ajax/reloadCaptcha';
$route['check_captcha'] = 'ajax/checkCaptcha';
...
$route['history/load_more_timeline/(:num)/(:num)/(:num)'] = "ajax/timelinePanigate/$1/$2/$3";
$route['timeline'] = "students/viewTimline";
$route['timeline/(:num)'] = "students/viewTimline/$1";
...
$route['shop'] = "students/viewShop";
$route['payment'] = "students/paymentHistory";
$route['payment/json_data'] = "json/getStudentPaymentHistoryJsonData";
